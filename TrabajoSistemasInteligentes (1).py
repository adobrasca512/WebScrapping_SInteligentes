...
#                      maximum=200)
# p1.start()
# p1.grid(row=1,column=1,ipadx=10,ipady=10, padx=10, pady=10)
# value_label = ttk.Label(root, text='Cargando Archivos...')
# value_label.grid(column=0, row=0, columnspan=2)
# value_label2 = ttk.Label(root, text='Porcentaje de carga: 10%')
# value_label2.grid(column=1, row=2, columnspan=2,ipadx=10,ipady=10)
# 
# root.mainloop()
